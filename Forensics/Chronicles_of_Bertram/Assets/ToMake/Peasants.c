...
void* makeDam(){
    Peasant* tmp= malloc(sizeof(Peasant));
    Peasant* pipe1 = malloc(sizeof(Peasant));
    pipe1->x = 5;
    strcpy(pipe1->value,"vi-98ja8");

    Peasant* pipe2 = malloc(sizeof(Peasant));
    pipe2->x = 8;
    pipe2->to = pipe1;
    strcpy(pipe2->value,"svikird_cfmvj_yzj_wrdzcp");

    Peasant* pipe3 = malloc(sizeof(Peasant));
    pipe3->x = 4;
    pipe3->to=pipe2;
    strcpy(pipe3->value,"x-uh09673");
...
void closeDam(void* tmp){
    Peasant* tmp1 = (Peasant*)tmp;
    Peasant* pipe1 = tmp1->to;
    Peasant* pipe2 = tmp1->to->to;
    Peasant* pipe3 = tmp1->to->to->to;
